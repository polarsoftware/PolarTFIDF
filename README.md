...
Polar TFIDF uses an [embedded database](https://www.litedb.org/) so larger amount of data can be processed. However, the option to connect to Postgres or MySQL databases is being coded right now.
